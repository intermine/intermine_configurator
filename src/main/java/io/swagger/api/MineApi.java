...
public interface MineApi {
    ...
    ResponseEntity<MineConfig> getMineConfig(@ApiParam(value = "ID of mine to fetch",required=true) @PathVariable("mineId") String mineId);
    ...
    @RequestMapping(value = "/mine/descriptors/{mineId}",
        produces = { "application/json", "application/xml" }, 
        method = RequestMethod.GET)
    ResponseEntity<MineDescriptor> getMineDescriptors(@ApiParam(value = "ID of mine to fetch",required=true) @PathVariable("mineId") String mineId);
    ...
    @RequestMapping(value = "/mine/descriptors/{mineId}",
        ...
        method = RequestMethod.POST)
    ResponseEntity<Void> setMineDescriptors(@ApiParam(value = "Descriptors to set for Mine" ,required=true )  @Valid @RequestBody MineDescriptor body,@ApiParam(value = "ID of mine to fetch",required=true) @PathVariable("mineId") String mineId);
